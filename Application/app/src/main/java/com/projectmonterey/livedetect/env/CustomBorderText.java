package com.projectmonterey.livedetect.env;
...
// FORKED(IE COPIED) FROM MY PREVIOUS CODE AND REPO
/** A class that encapsulates the tedious bits of rendering legible, bordered text onto a canvas. */
public class CustomBorderText {
     ...
     */
    public CustomBorderText(final float textSize) {
     ...
     * @param textSize text size in pixels
     */
    public CustomBorderText(final int interiorColor, final int exteriorColor, final float textSize) {
